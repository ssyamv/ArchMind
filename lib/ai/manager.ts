...
const DEFAULT_MODEL_CONFIG: AIModelsConfig = {
  ...
  models: {
    'glm-4.7': { enabled: true, name: 'GLM-4.7', provider: 'Zhipu AI', description: '旗舰推理模型，355B MoE，200K 上下文，编码能力对标 Claude Sonnet 4.5，支持思考模式', api_key_env: 'GLM_API_KEY', capabilities: { maxContextLength: 200000, supportsStreaming: true, supportsStructuredOutput: true, supportsVision: false, supportsThinking: true, supportedLanguages: ['zh', 'en'] }, costEstimate: { input: '¥0.1 / 1M tokens', output: '¥0.1 / 1M tokens' } },
    'glm-4.6v': { enabled: false, name: 'GLM-4.6V', provider: 'Zhipu AI', description: '多模态视觉理解模型，支持图像输入', api_key_env: 'GLM_API_KEY', capabilities: { maxContextLength: 128000, supportsStreaming: true, supportsStructuredOutput: true, supportsVision: true, supportsThinking: false, supportedLanguages: ['zh', 'en'] }, costEstimate: { input: '¥0.04 / 1M tokens', output: '¥0.1 / 1M tokens' } },
    'glm-4.5-air': { enabled: true, name: 'GLM-4.5 Air', provider: 'Zhipu AI', description: '高性价比轻量模型，适合高并发低成本场景', api_key_env: 'GLM_API_KEY', capabilities: { maxContextLength: 128000, supportsStreaming: true, supportsStructuredOutput: true, supportsVision: false, supportsThinking: true, supportedLanguages: ['zh', 'en'] }, costEstimate: { input: '¥0.05 / 1M tokens', output: '¥0.05 / 1M tokens' } },
    'claude-sonnet-4-6': { enabled: false, name: 'Claude Sonnet 4.6', provider: 'Anthropic', description: '最新平衡版，接近 Opus 4.6 的编码能力，1/5 的价格', api_key_env: 'ANTHROPIC_API_KEY', capabilities: { maxContextLength: 200000, supportsStreaming: true, supportsStructuredOutput: true, supportsVision: true, supportsThinking: true, supportedLanguages: ['zh', 'en'] }, costEstimate: { input: '$3 / 1M tokens', output: '$15 / 1M tokens' } },
    'gpt-4.1': { enabled: false, name: 'GPT-4.1', provider: 'OpenAI', description: '编码专项优化，100 万 tokens 上下文', api_key_env: 'OPENAI_API_KEY', capabilities: { maxContextLength: 1000000, supportsStreaming: true, supportsStructuredOutput: true, supportsVision: true, supportsThinking: false, supportedLanguages: ['zh', 'en'] }, costEstimate: { input: '$2 / 1M tokens', output: '$8 / 1M tokens' } },
    'gemini-2.5-pro': { enabled: false, name: 'Gemini 2.5 Pro', provider: 'Google', description: '最新思维旗舰，100 万 tokens 上下文，Deep Think 增强推理', api_key_env: 'GOOGLE_API_KEY', capabilities: { maxContextLength: 1000000, supportsStreaming: true, supportsStructuredOutput: true, supportsVision: true, supportsThinking: false, supportedLanguages: ['zh', 'en'] }, costEstimate: { input: '$1.25 / 1M tokens', output: '$10 / 1M tokens' } },
    'qwen3-max': { enabled: false, name: 'Qwen3-Max', provider: 'Alibaba', description: '千问3系旗舰，原生 search/code agent，思考与非思考模式', api_key_env: 'DASHSCOPE_API_KEY', capabilities: { maxContextLength: 131072, supportsStreaming: true, supportsStructuredOutput: true, supportsVision: false, supportsThinking: false, supportedLanguages: ['zh', 'en'] }, costEstimate: { input: '¥24 / 1M tokens', output: '¥72 / 1M tokens' } },
    'deepseek-chat': { enabled: false, name: 'DeepSeek V3.2', provider: 'DeepSeek', description: '最新通用模型，工具调用集成思考，高性价比', api_key_env: 'DEEPSEEK_API_KEY', capabilities: { maxContextLength: 128000, supportsStreaming: true, supportsStructuredOutput: true, supportsVision: false, supportsThinking: false, supportedLanguages: ['zh', 'en'] }, costEstimate: { input: '¥0.5 / 1M tokens', output: '¥2 / 1M tokens' } },
    'ernie-4.0-8k': { enabled: false, name: '文心 ERNIE 4.0', provider: 'Baidu', description: '百度旗舰大模型，中文理解深度强', api_key_env: 'BAIDU_API_KEY', capabilities: { maxContextLength: 8192, supportsStreaming: true, supportsStructuredOutput: false, supportsVision: false, supportsThinking: false, supportedLanguages: ['zh', 'en'] }, costEstimate: { input: '¥30 / 1M tokens', output: '¥60 / 1M tokens' } }
  }
}
